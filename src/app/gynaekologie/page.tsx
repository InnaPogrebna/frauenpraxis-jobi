...
function GynaekologieContent() {
  ...
  const [activeTab, setActiveTab] = useState("krebsvorsorge");
  ...
  useEffect(() => {
    const frame = requestAnimationFrame(() => {
      setIsMounted(true);
      setTimeout(() => setTabsVisible(true), 100);
    });
  ...
  return (
    <div className="min-h-screen bg-[#FCFBFA] overflow-x-hidden">
      <Header />
      ...
      <section className="relative h-[65vh] md:h-[75vh] flex items-center overflow-hidden">
        ...
        >
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-transparent to-[#FCFBFA]" />
        </motion.div>
            ...
            >
              <Tabs
                ...
                <div className="max-w-6xl w-full mx-auto outline-none">
                  <TabsContent value="krebsvorsorge" className="m-0 outline-none focus:ring-0"><MainVorsorge /></TabsContent>
                  <TabsContent value="verhuetung" className="m-0 outline-none focus:ring-0"><EmpfaengnisSection /></TabsContent>
                  <TabsContent value="wechseljahre" className="m-0 outline-none focus:ring-0"><WechseljahreSection /></TabsContent>
                  <TabsContent value="erweitert" className="m-0 outline-none focus:ring-0"><ErweiterteVorsorge /></TabsContent>
                  <TabsContent value="impfcheck" className="m-0 outline-none focus:ring-0"><ImpfCheck /></TabsContent>
                </div>
              </Tabs>
            </motion.div>
          )}
