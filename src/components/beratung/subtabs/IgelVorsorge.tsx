          ...
          >
            {igelCategories.map((cat) => (
              <motion.div
                ...
                className="group p-8 rounded-[40px] bg-white border border-rose-100/50 cursor-pointer flex flex-col justify-between min-h-[220px] transition-all"
              >
                ...
                <h4 className="text-xl font-serif italic text-slate-900 leading-tight pr-8">
                  {cat.title}
                </h4>
              </motion.div>
            ))}
